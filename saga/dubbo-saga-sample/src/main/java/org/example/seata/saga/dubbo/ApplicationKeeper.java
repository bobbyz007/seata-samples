 ...
 */
package org.example.seata.saga.dubbo;
...
public class ApplicationKeeper {
     ...
     */
    public ApplicationKeeper(ConfigurableApplicationContext applicationContext) {
        addShutdownHook(applicationContext);
    }

    private void addShutdownHook(final ConfigurableApplicationContext applicationContext) {
